...
class Day4Puzzle2 extends TestCase
{
    ...
    public function test()
    {
        ...
        $mostSleptMinuteByGuardId = collect($shiftsByGuard)
            ->mapWithKeys(function ($shifts, $guardId) {
                $listOfMinutesAsleep = [];
                ...
                return [$guardId => [
                    'occurances' => collect(array_count_values($listOfMinutesAsleep))->sort()->last(),
                    'minute' => collect(array_count_values($listOfMinutesAsleep))->sort()->keys()->last(),
                ]];
            });

            $answer = $mostSleptMinuteByGuardId->sortBy('occurances')->keys()->last()
                * $mostSleptMinuteByGuardId->sortBy('occurances')->last()['minute'];

            $this->assertEquals(19896, $answer);
    }
